...
int main(int argc, char **argv) {
  ...
  // bc_on = 1 means hard walls with constant eta
  if (argc != 5) {
...
void update_gradient_matrix(int i, int j) {
  // Implement periodic boundary conditions and update graidents at neighbours of site (i,j)
  int im1, jm1, ip1, jp1;
  if (i == 0) {
    im1 = N - 1;
  }  else im1 = i - 1;
